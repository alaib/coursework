...
/**
 * OEServerImpl implements the interface OEServerInterface and provides remote object to client
 * @author ravikirn
 *
 */
public class OERelayServerImpl extends UnicastRemoteObject implements OERelayServerInterface {    	
	//ClientListMap
    ...
    public OERelayServerImpl (String msg) throws RemoteException {  
    ...
    public class OEServerModel{
    	public OEServerModel(OERelayServerImpl ts){
