...
savedFileName = strcat('savedWang3/', hla1, '_', hla2, '_admm_svm.mat');
...
legend('Fused ADMM', 'SVM', 'Location', 'SouthEast');

figure(2);
X_hla1 = {'Precision' 'Recall' 'F1-Score' 'Accuracy'};
Y_hla1 = zeros(4, 2);
Y_hla1(1,:) = [hla1_admm_score.prec, hla1_svm_score.prec];
Y_hla1(2,:) = [hla1_admm_score.recall, hla1_svm_score.recall];
Y_hla1(3,:) = [hla1_admm_score.f1, hla1_svm_score.f1];
Y_hla1(4,:) = [hla1_admm_score.acc, hla1_svm_score.acc];
hold on;
title(hla1);
bar(Y_hla1);
set(gca,'XTick',(1:3));
set(gca,'XTickLabel', X_hla1);
legend('Fused ADMM', 'SVM', 'Location', 'NorthEast');
...
Y_hla2 = zeros(4, 2);
Y_hla2(1,:) = [hla2_admm_score.prec, hla2_svm_score.prec];
Y_hla2(2,:) = [hla2_admm_score.recall, hla2_svm_score.recall, ];
Y_hla2(3,:) = [hla2_admm_score.f1, hla2_svm_score.f1,];
Y_hla2(4,:) = [hla2_admm_score.acc, hla2_svm_score.acc];
hold on;
title(hla2);
bar(Y_hla2);
set(gca,'XTick',(1:3));
