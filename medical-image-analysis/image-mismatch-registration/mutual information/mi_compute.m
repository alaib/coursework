...
for i = 1:size(deltax,2) 
    ...
    mismatch_arr(1,deltax(i)+initval+1) = mi(baseimg(startx+1:startx+256,starty+1:starty+256), ...
                                             tempimg1(startx+1:startx+256,starty+1:starty+256));
    mismatch_arr(2,deltax(i)+initval+1) = mi(baseimg(startx+1:startx+256,starty+1:starty+256), ...
                                             tempimg2(startx+1:startx+256,starty+1:starty+256));
    mismatch_arr(3,deltax(i)+initval+1) = mi(baseimg(startx+1:startx+256,starty+1:starty+256), ...
                                             tempimg3(startx+1:startx+256,starty+1:starty+256)); 
    mismatch_arr(4,deltax(i)+initval+1) = mi(baseimg(startx+1:startx+256,starty+1:starty+256), ...
...
ylabel('Mutual Information with Transformation 1');
hold on;
...
axis on;
xlabel('Translation Value - deltax');
ylabel('Mutual Information with Transformation 2');
hold on;
...
axis on;
xlabel('Translation Value - deltax');
ylabel('Mutual Information with Transformation 3');
hold on;
...
axis on;
xlabel('Translation Value - deltax');
ylabel('Mutual Information with Transformation 4');
hold on;
