...
for i = 1:size(deltax,2) 
    ...
    mismatch_arr(1,deltax(i)+initval+1) = sum_of_squared_intensity_differences( baseimg, ...
                                  tempimg1, startx+1, startx+256, starty+1, starty+256);               
    mismatch_arr(2,deltax(i)+initval+1) = sum_of_squared_intensity_differences( baseimg, ...
                                  tempimg2, startx+1, startx+256, starty+1, starty+256);               
    mismatch_arr(3,deltax(i)+initval+1) = sum_of_squared_intensity_differences( baseimg, ...
                                  tempimg3, startx+1, startx+256, starty+1, starty+256);               
    mismatch_arr(4,deltax(i)+initval+1) = sum_of_squared_intensity_differences( baseimg, ...
...
ylabel('Sum of Squared Intensity Diff with Transform 1');
hold on;
...
axis on;
xlabel('Translation Value - deltax');
ylabel('Sum of Square Intensity Diff with Transform 2');
hold on;
...
axis on;
xlabel('Translation Value - deltax');
ylabel('Sum of Square Intensity Diff with Transform 3');
hold on;
...
axis on;
xlabel('Translation Value - deltax');
ylabel('Sum of Square Intensity Diff with Transform 4');
hold on;
