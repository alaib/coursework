...
mismatch_val2 = quantile_function_diff( baseimg, ...
                                  tempimg, startx+1, startx+256, starty+1, starty+256, normalized_quantile);
deltaxArr(1) = deltax;
...
[tempimg, xdata, ydata] = imtransform(movimg, tform, ...
                              'XData', [1 size(movimg,2)], 'YData', [1 size(movimg,1)]);
mismatch_val1 = quantile_function_diff( baseimg, ...
                                  tempimg, startx+1, startx+256, starty+1, starty+256, normalized_quantile);                                                         
...
[tempimg, xdata, ydata] = imtransform(movimg, tform, ...
                              'XData', [1 size(movimg,2)], 'YData', [1 size(movimg,1)]);
mismatch_val3 = quantile_function_diff( baseimg, ...
                                  tempimg, startx+1, startx+256, starty+1, starty+256, normalized_quantile);                              
skipFlag = false;                              
...
while true    
    ...
    [tempimg, xdata, ydata] = imtransform(movimg, tform, ...
                                  'XData', [1 size(movimg,2)], 'YData', [1 size(movimg,1)]);
    next_val = quantile_function_diff( baseimg, ...
                                      tempimg, startx+1, startx+256, starty+1, starty+256, normalized_quantile);
