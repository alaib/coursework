...
mismatch_val2 = normalized_cross_correlation( baseimg, ...
...
[tempimg, xdata, ydata] = imtransform(movimg, tform, ...
                              'XData', [1 size(movimg,2)], 'YData', [1 size(movimg,1)]);
mismatch_val1 = normalized_cross_correlation( baseimg, ...
                                  tempimg, startx+1, startx+256, starty+1, starty+256);                                                         
...
[tempimg, xdata, ydata] = imtransform(movimg, tform, ...
                              'XData', [1 size(movimg,2)], 'YData', [1 size(movimg,1)]);
mismatch_val3 = normalized_cross_correlation( baseimg, ...
                                  tempimg, startx+1, startx+256, starty+1, starty+256);                              
skipFlag = false;                              
...
while true    
    ...
    [tempimg, xdata, ydata] = imtransform(movimg, tform, ...
                                  'XData', [1 size(movimg,2)], 'YData', [1 size(movimg,1)]);
    next_val = normalized_cross_correlation( baseimg, ...
                                      tempimg, startx+1, startx+256, starty+1, starty+256);
